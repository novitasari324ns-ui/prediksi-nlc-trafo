# ============================================================
#  PREDIKSI NO LOAD CURRENT TRAFO DISTRIBUSI 1 FASA
...
print("="*60)
print("  PREDIKSI NO LOAD CURRENT TRAFO 1 FASA — PT BAMBANG DJAJA")
...
fig.suptitle(
    'Prediksi No Load Current Trafo 1 Fasa — PT Bambang Djaja\n'
...
print(f"    {'Tipe Inti':<12} {'NL Loss':>10}  {'Prediksi NLC%':>14}")
print(f"    {'-'*40}")
contoh = [
